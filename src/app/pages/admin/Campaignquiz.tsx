...
/* ✅ Always hoverable — user can reselect */
...
/* Reselect hint — shown below options while answer is selected but not confirmed */
.cq-reselect-hint {
  padding: 10px 20px 0;
...
/* Next button */
.cq-next-wrap { padding: 14px 20px 0; }
.cq-next {
...
.cq-winner-text {
  ...
  font-size: 15px; font-weight: 800; color: #fff; margin-bottom: 0; line-height: 1.15;
}
.cq-winner-text .big {
...
.cq-player-avatar-crown { position: absolute; top: -14px; left: 50%; transform: translateX(-50%); font-size: 16px; }
...
.cq-player-name { font-family: 'Poppins', sans-serif; font-size: 17px; font-weight: 800; color: #0F0A27; margin-bottom: 2px; }
...
.cq-stat { background: #F9F7FF; border: 1.5px solid #EDE9FE; border-radius: 16px; padding: 14px 16px; text-align: center; }
.cq-stat-icon-row { display: flex; align-items: center; justify-content: center; gap: 6px; margin-bottom: 4px; }
...
.cq-stat-value { font-family: 'Poppins', sans-serif; font-size: 26px; font-weight: 900; color: #1A1530; line-height: 1; }
.cq-stat-sub { font-size: 10px; font-weight: 700; color: #A78BFA; margin-top: 3px; }

.cq-lb-card { margin: 16px 16px 0; background: #fff; border: 1.5px solid #EDE9FE; border-radius: 20px; overflow: hidden; }
.cq-lb-head { padding: 14px 18px 12px; display: flex; align-items: center; justify-content: space-between; border-bottom: 1px solid #F0EDFF; }
.cq-lb-title { font-family: 'Poppins', sans-serif; font-size: 14px; font-weight: 800; color: #0F0A27; display: flex; align-items: center; gap: 7px; }
.cq-lb-title svg { width: 18px; height: 18px; stroke-width: 2; fill: none; stroke: #F59E0B; }
.cq-lb-subtitle { font-size: 10px; font-weight: 700; color: #9CA3AF; letter-spacing: .2px; margin-top: 1px; }
.cq-lb-viewall { font-size: 12px; font-weight: 700; color: #7C3AED; background: none; border: none; cursor: pointer; display: flex; align-items: center; gap: 2px; }
...
.cq-lb-row { display: flex; align-items: center; gap: 10px; padding: 10px 12px; border-radius: 12px; background: #F9F8FF; border: 1px solid transparent; font-size: 13px; }
.cq-lb-row.me { background: #EDE9FF; border-color: #C4B5FD; }
.cq-lb-rank-num { width: 28px; height: 28px; border-radius: 50%; flex-shrink: 0; display: flex; align-items: center; justify-content: center; font-family: 'Poppins', sans-serif; font-size: 12px; font-weight: 900; }
...
.cq-lb-avatar { width: 34px; height: 34px; border-radius: 50%; flex-shrink: 0; display: flex; align-items: center; justify-content: center; font-family: 'Poppins', sans-serif; font-size: 13px; font-weight: 900; color: #fff; background: linear-gradient(135deg, #A78BFA, #6D28D9); }
.cq-lb-name { flex: 1; font-weight: 800; color: #0F0A27; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.cq-lb-name.me { color: #6D28D9; }
.cq-lb-you { font-size: 10px; font-weight: 900; background: #6D28D9; color: #fff; padding: 2px 7px; border-radius: 100px; margin-left: 5px; }
.cq-lb-time { font-size: 12px; font-weight: 700; color: #6B7280; flex-shrink: 0; }
.cq-lb-place { font-size: 12px; font-weight: 900; color: #374151; flex-shrink: 0; min-width: 36px; text-align: right; }
.cq-lb-place.p1 { color: #D97706; }
.cq-lb-empty {
  text-align: center; padding: 20px 16px;
  display: flex; flex-direction: column; align-items: center; gap: 6px;
}
.cq-lb-empty-icon { font-size: 28px; line-height: 1; }
.cq-lb-empty-text { font-size: 13px; font-weight: 700; color: #9CA3AF; }
.cq-lb-empty-sub { font-size: 11px; font-weight: 600; color: #C4B5FD; }

.cq-review-card { margin: 14px 16px 0; background: #fff; border: 1.5px solid #EDE9FE; border-radius: 20px; overflow: hidden; }
.cq-review-head { padding: 14px 18px 12px; display: flex; align-items: center; justify-content: space-between; border-bottom: 1px solid #F0EDFF; }
.cq-review-title { font-family: 'Poppins', sans-serif; font-size: 14px; font-weight: 800; color: #0F0A27; display: flex; align-items: center; gap: 7px; }
...
.cq-review-item { display: flex; align-items: flex-start; gap: 10px; padding: 11px 13px; border-radius: 12px; border: 1.5px solid transparent; }
...
.cq-btn-reward { width: 100%; height: 54px; border: none; border-radius: 16px; background: linear-gradient(135deg, #6D28D9, #A855F7); color: #fff; font-family: 'Poppins', sans-serif; font-size: 15px; font-weight: 800; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 8px; box-shadow: 0 4px 20px rgba(109,40,217,.4); transition: transform .1s, box-shadow .15s; }
...
.cq-btn-again { width: 100%; height: 54px; border: 1.5px solid #E5E7EB; border-radius: 16px; background: #fff; color: #374151; font-family: 'Poppins', sans-serif; font-size: 15px; font-weight: 700; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 8px; transition: border-color .15s, color .15s; }
...
function Confetti() {
  return (
    <div className="cq-hero-confetti">
      {DOTS.map((d, i) => (
        <span key={i} style={{ background: d.color, left: d.l, width: d.w, height: d.h, animationDelay: d.d, top: 0 }} />
      ))}
    </div>
  );
}
...
export function CampaignQuiz() {
  ...
  // selectedOption is just UI state — user can change it freely before confirming
  const [selectedOption, setSelectedOption] = useState<string | null>(null);
  // confirmed tracks whether user has locked in their answer (clicked Next / confirmed)
  ...
  useEffect(() => {
    ...
    (async () => {
      const { data: camp, error: campErr } = await supabase
        .from("campaigns").select("id, name, is_active, question_count").eq("id", campaignId).single();
      ...
      // How many questions to show — from campaign setting, default 5
      const SHOW_COUNT: number = camp.question_count ?? 5;
      ...
      // Shuffle all questions then take only SHOW_COUNT (default 5)
      const shuffled = [...qs].sort(() => Math.random() - 0.5);
      const selected = shuffled.slice(0, Math.min(SHOW_COUNT, shuffled.length));
  ...
  // Select just updates UI — no lock-in
  const handleSelectOption = (letter: string) => {
    if (confirmed) return;
    setSelectedOption(letter);
  };

  // "Next" button locks in the answer, then advances
  const handleNext = useCallback(async () => {
    ...
    // Lock in the answer
    const newAnswers = [...answers, { questionId: q.id, chosen: selectedOption, correct: isCorrect }];
    setAnswers(newAnswers);
    setConfirmed(true);

    // Small delay so user sees the lock-in, then advance
  ...
  }, [currentIndex, questions, answers, selectedOption, elapsed]);
  ...
  const submitResult = async (finalScore: number, total: number) => {
    ...
    try {
      await supabase.from("quiz_results").insert({
        ...
        player_mobile: participant.mobile,
  ...
  // ── Fetch Leaderboard ──
  // ✅ Only shows participants with 100% score (all questions correct)
  // ✅ Sorted by fastest elapsed_seconds
  // ✅ Limited to top 5
  const fetchLeaderboard = async () => {
    ...
    const { data } = await supabase
      .from("quiz_results")
      .select("id, player_name, score, total, percentage, elapsed_seconds, completed_at")
      .eq("campaign_id", campaignId)
      .eq("percentage", 100)                          // ✅ Only perfect scores
      .order("elapsed_seconds", { ascending: true })  // ✅ Fastest time first
      .limit(5);                                      // ✅ Top 5 only
      ...
      <>
        ...
        <div className="cq">
          <div className="cq-results">
            ...
            {/* ✅ LEADERBOARD — Perfect scores only, fastest time, top 5 */}
            <div className="cq-lb-card">
              <div className="cq-lb-head">
                <div>
                  <div className="cq-lb-title">
                  ...
                  <p className="cq-lb-subtitle">All correct · Fastest 5 players</p>
                </div>
              ...
              <div className="cq-lb-body">
                {loadingLeaderboard ? (
                  ...
                  <div className="cq-lb-empty">
                    <span className="cq-lb-empty-icon">🎯</span>
                    <p className="cq-lb-empty-text">No perfect scores yet!</p>
                    <p className="cq-lb-empty-sub">Answer all questions correctly to appear here</p>
                  </div>
    ...
    <>
      ...
      <div className="cq">
        <div className="cq-play">
          ...
          {/* Options — never disabled, always clickable to reselect */}
          ...
          {/* Reselect hint — shown while answer is selected but before confirming */}
          {hasSelected && (
            <p className="cq-reselect-hint">
              Tap another option to change your answer
            </p>
          )}

          {/* Next / Submit button — only shown after selecting */}
          {hasSelected && (
            <div className="cq-next-wrap">
              <button className="cq-next" onClick={handleNext} disabled={submitting}>
                {submitting && <Loader2 size={16} style={{ animation:"spin 1s linear infinite" }} />}
                {currentIndex < questions.length - 1 ? "Confirm & Next →" : "Confirm & See Results →"}
              </button>
            </div>
          )}
